                ...
                Expanded(
                  child: Column(
                    children: [
                      ...
                      _buildCompactStat(icon: Icons.block, label: 'Current', value: '${_miningStats!.currentBlock}'),
                    ],
                  ),
                ),
                ...
                Expanded(
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 16),
                      _buildCompactStat(icon: Icons.sync, label: 'Target', value: '${_miningStats!.targetBlock}'),
                    ],
                  ),
                ),
              ],
