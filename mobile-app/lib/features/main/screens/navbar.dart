...
class Navbar extends ConsumerStatefulWidget {
  ...
  const Navbar({super.key, this.address, this.transaction, this.showReferralOnLaunch = false, this.initialIndex = 0});
  ...
  Widget _buildBody() {
    return IndexedStack(
      ...
      children: [
        ...
        TransactionsScreen(transaction: widget.transaction),
