  ...
  void _navigateToRecoveryPhrase() {
    ...
    accountsAsync.whenData((accounts) {
      ...
      if (walletIndices.length == 1) {
        Navigator.push(context, MaterialPageRoute(builder: (_) => ShowRecoveryPhraseScreen(walletIndex: walletIndices.first)));
      } else {
        Navigator.push(context, MaterialPageRoute(builder: (_) => const SelectWalletForRecoveryPhraseScreen()));
      }
    });
  }
